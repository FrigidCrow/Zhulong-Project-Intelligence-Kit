...
description: AI-PIKit native milestone completion workflow for Claude Code.
---

# AI-PIKit Complete Milestone

Use this when the user invokes `/pik-complete-milestone`.

1. Run `{{PIK_CLI}} workflow run complete-milestone --target . "$ARGUMENTS"`.
