...
- init --target <tmp>/zhulong-ambiguity-3oNk86/project --template greenfield-app --name ambiguity_fixture --mode new --force: exit 0
- docs sync --target <tmp>/zhulong-ambiguity-3oNk86/project: exit 0
...
- ambiguity audit --target <tmp>/zhulong-ambiguity-3oNk86/project --strict: exit 1
