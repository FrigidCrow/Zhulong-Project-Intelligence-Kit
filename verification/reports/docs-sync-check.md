...
- zl init --target <tmp>/zhulong-docs-sync-GiY1zG/project --template greenfield-app --name docs_sync_fixture --mode new --force: exit 0
- zl docs sync --target <tmp>/zhulong-docs-sync-GiY1zG/project: exit 0
...
- zl docs citations --target <tmp>/zhulong-docs-sync-GiY1zG/project DOCS_SYNC_SENTINEL_4101: exit 0
- zl docs sync --target <tmp>/zhulong-docs-sync-GiY1zG/project: exit 0
...
- zl docs citations --target <tmp>/zhulong-docs-sync-GiY1zG/project DOCS_SYNC_SENTINEL_4102: exit 0
- zl docs sync --target <tmp>/zhulong-docs-sync-GiY1zG/project --index: exit 0
...
- Work root: `<tmp>/zhulong-docs-sync-GiY1zG`
- Project root: `<tmp>/zhulong-docs-sync-GiY1zG/project`
